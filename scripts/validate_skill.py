"""
Validate the vulcan-testkit LuaSkill repository against strict package rules.
校验 vulcan-testkit LuaSkill 仓库是否满足严格包结构规则。
"""
...
"""
Validate the dependency manifest used by the vulcan-testkit package.
校验 vulcan-testkit 包使用的依赖清单。
"""
